...
--
-- local_path   → container-internal path, e.g. /data/downloads/Calculus/file.pdf
--                Always relative to the Docker volume mount, so the path never
--                changes between machines regardless of host directory.
--
...
CREATE TABLE IF NOT EXISTS archive (
    ...
    local_path      TEXT        NOT NULL,       -- container-internal path
